...
const ProjectGrid = () => {
  ...
  return (
    <>
      {/* You can add an UI element for selecting a category (such as Development or Design). 
      Clicking on one of the category names would set the filter state accordingly using the setFilter function.   */}
